#!/usr/bin/env python3
"""Elevate remove+retake of post-upgrade-system-8.19.18-20260724 Hyper-V snaps."""
...
PS1 = ROOT / "Remove-And-Retake-HyperVSnap.ps1"
LOG = ROOT / "logs" / "hv-retake-post-81918.log"
